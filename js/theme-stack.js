...
(function () {
    ...
    function initSmartHeader() {
        ...
        function update() {
            ...
            header.classList.toggle('kg-header--compact', currentY > 160 && currentY > lastY);
            if (currentY < 80 || currentY < lastY) {
                header.classList.remove('kg-header--compact');
            }
            lastY = currentY;
            ticking = false;
        }
    ...
    function initGsapReveals() {
        if (typeof gsap === 'undefined' || typeof ScrollTrigger === 'undefined') {
            var fallback = document.querySelectorAll('[data-kg-animate]');
            fallback.forEach(function (item) {
                item.classList.add('kg-animate-ready');
            });
            return;
        }

        var items = gsap.utils.toArray('[data-kg-animate]');
        ...
        mm.add('(prefers-reduced-motion: reduce)', function() {
            items.forEach(function(item) { item.classList.add('kg-animate-ready'); });
            return function() {};
        });
        ...
        document.addEventListener('alpine:init', function () {
            ...
            Alpine.data('kgHome', function () {
                ...
                return {
                    ...
                    schools: [
                        { n:'01', name:'Arte', desc:'Historia del arte, curadur\u00eda y gesti\u00f3n cultural.', img:'https://letras.unmsm.edu.pe/wp-content/uploads/2019/07/arte.jpg', href:'https://letras.unmsm.edu.pe/escuelas/arte-kg/' },
                        { n:'02', name:'Bibliotecolog\u00eda y CC. de la Informaci\u00f3n', desc:'Gesti\u00f3n del conocimiento y acceso a la informaci\u00f3n.', img:'https://letras.unmsm.edu.pe/wp-content/uploads/2021/01/Bibliotecologia.jpeg', href:'https://letras.unmsm.edu.pe/escuelas/bibliotecologia-kg/' },
                        { n:'03', name:'Comunicaci\u00f3n Social', desc:'Periodismo, medios y comunicaci\u00f3n para el cambio.', img:'https://letras.unmsm.edu.pe/wp-content/uploads/2019/07/comunica.jpg', href:'https://letras.unmsm.edu.pe/escuelas/comunicacion-social-kg/' },
                        { n:'04', name:'Conservaci\u00f3n y Restauraci\u00f3n', desc:'Patrimonio material, ciencia y memoria.', img:'https://letras.unmsm.edu.pe/wp-content/uploads/2021/01/WhatsApp-Image-2021-01-05-at-3.38.22-PM.jpeg', href:'https://letras.unmsm.edu.pe/escuelas/conservacion-y-restauracion-kg/' },
                        { n:'05', name:'Danza', desc:'Cuerpo, coreograf\u00eda e investigaci\u00f3n esc\u00e9nica.', img:'https://letras.unmsm.edu.pe/wp-content/uploads/2019/07/danza.jpg', href:'https://letras.unmsm.edu.pe/escuelas/danza-kg/' },
                        { n:'06', name:'Filosof\u00eda', desc:'Pensamiento cr\u00edtico, \u00e9tica y tradici\u00f3n de las ideas.', img:'https://letras.unmsm.edu.pe/wp-content/uploads/2019/07/Filosofia.jpg', href:'https://letras.unmsm.edu.pe/escuelas/filosofia-kg/' },
                        { n:'07', name:'Literatura', desc:'Cr\u00edtica, creaci\u00f3n e historia literaria peruana y universal.', img:'https://letras.unmsm.edu.pe/wp-content/uploads/2019/07/literatura.jpg', href:'https://letras.unmsm.edu.pe/escuelas/literatura-kg/' },
                        { n:'08', name:'Ling\u00fc\u00edstica', desc:'El lenguaje, las lenguas originarias y el pensamiento.', img:'https://letras.unmsm.edu.pe/wp-content/uploads/2021/01/linguistica-pagina-e1609879534767.jpg', href:'https://letras.unmsm.edu.pe/escuelas/linguistica-kg/' },
                        { n:'09', name:'Estudios Generales', desc:'Formaci\u00f3n human\u00edstica com\u00fan de primer ciclo.', img:'https://letras.unmsm.edu.pe/wp-content/uploads/2026/02/portada.png', href:'https://letras.unmsm.edu.pe/escuelas/estudios-generales-kg/' },
                        { n:'10', name:'Lenguas, Traducci\u00f3n e Interpretaci\u00f3n', desc:'Di\u00e1logo intercultural en varias lenguas.', img:'https://letras.unmsm.edu.pe/wp-content/uploads/2025/01/interpretacion-1024x384.jpg', href:'https://letras.unmsm.edu.pe/escuelas/lenguas-traduccion-e-interpretacion-kg/' },
                    ],
